...
function EN12900_EngUnits
  ...
  input Modelica.Units.SI.Temperature T_cd "Condensing temperature";
  input Modelica.Units.SI.Temperature T_ev "Evaporation temperature";
...
protected
  ...
  Modelica.Units.SI.Power Wdot "Compressor Power";
