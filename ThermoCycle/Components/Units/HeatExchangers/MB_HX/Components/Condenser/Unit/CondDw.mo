...
ThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Wall.wall Wall(
  ...
  ThermoCycle.Interfaces.Fluid.Flange_Cdot InFlowSF
    ...
    ThermoCycle.Components.Units.HeatExchangers.MB_HX.Components.Condenser.CondDry
    CondDry(
    ...
    VoidF=VoidF)
    annotation (Placement(transformation(extent={{-30,-86},{32,-48}})));
  ...
  record SummaryClass
    replaceable Arrays T_profile;
     record Arrays
      ...
      Modelica.Units.SI.Temperature[6] Twall;
