...
block VariableValveTimer
  ...
  input Modelica.Units.SI.Angle open=Modelica.Units.Conversions.from_deg(170)
    "Half opened";

  input Modelica.Units.SI.Angle close=Modelica.Units.Conversions.from_deg(190)
    "Half closed";

  input Modelica.Units.SI.Angle switch=Modelica.Units.Conversions.from_deg(5)
