...
package FillerMaterial
  ...
  record MaterialBase
    ...
    parameter Modelica.Units.SI.Density rho_sol=2707
      "Density of the filler material";
    parameter Modelica.Units.SI.SpecificHeatCapacity cp_sol=896
      "Specific heat capacity of the filler material";
    parameter Modelica.Units.SI.ThermalConductivity k_sol=204
