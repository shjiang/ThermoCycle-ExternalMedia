...
constant Real pi = Modelica.Constants.pi;
  parameter Modelica.Units.SI.Area S_net=41 "Net Collecting Surface";
  parameter Modelica.Units.SI.Length A_P=2.37 "Aperture of the parabola";
  parameter Modelica.Units.SI.Length Dext_t=0.0424 "External diameter tube";
  parameter Modelica.Units.SI.Length th_t=0.002 "tube thickness";

  final parameter Modelica.Units.SI.Length L=S_net/A_P "length of tubes";
  final parameter Modelica.Units.SI.Area A_ext_t=pi*Dext_t*L
    "Lateral external area of the tube";
  final parameter Modelica.Units.SI.Area S_ext_t=Dext_t*L
  ...
  final parameter Modelica.Units.SI.Area A_int_t=L*D_int_t*pi
