...
parameter HTtypes HTtype_wf=HTtypes.LiqVap
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer Unom_l=300
    "if HTtype = LiqVap: heat transfer coeff, liquid zone."
    annotation (Dialog(group="Heat transfer", tab="General"));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer Unom_tp=700
    "if HTtype = LiqVap: heat transfer coeff, two-phase zone."
    annotation (Dialog(group="Heat transfer", tab="General"));
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer Unom_v=400
    "if HTtype = LiqVap: heat transfer coeff, vapor zone."
    annotation (Dialog(group="Heat transfer", tab="General"));
/*METAL WALL*/
...
/*INITIAL VALUES*/
  /*pressure*/
  parameter Modelica.Units.SI.Pressure pstart_sf=1e5
    "Nominal inlet pressure of secondary fluid"
...
record SummaryBase
  ...
  record Arrays
   ...
   Real PinchPoint;
    ...
    Modelica.Units.SI.Pressure p_sf;
