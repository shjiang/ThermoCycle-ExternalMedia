...
TILMedia.Refrigerant fluid_su(
  ...
  //---------------------------
  parameter Modelica.Units.SI.Volume V_s=22.4e-6 "Displacement";
  parameter Real r_v_in=2.85;
  parameter Modelica.Units.SI.Length d_su=6.18e-3;
  parameter Modelica.Units.SI.MassFlowRate M_dot_n=0.1;
  ...
  parameter Modelica.Units.SI.Area A_leak=2.6e-6;
  parameter Modelica.Units.SI.Power W_dot_loss0=0;
 ...
 // parameter componentsNew.functions.ExpanderType exptype="User defined";
  ...
  parameter Modelica.Units.SI.HeatFlowRate Q_dot_amb_start=226
    ...
    annotation (dialog(tab="Start Values"));
  parameter Modelica.Units.SI.Frequency N_rot_start=50 "Rotating speed in Hz"
    annotation (dialog(tab="Start Values"));
  ...
  Modelica.Units.SI.Density rho_su(start=
  ...
  Modelica.Units.SI.Temperature DELTAT_su;
  ...
  Modelica.Units.SI.Pressure p_thr(start=p_thr_start);
  ...
  Modelica.Units.SI.HeatFlowRate res(start=0);
  ...
  Real FF;
  Modelica.Units.SI.SpecificEnthalpy h_ex(start=
        TILMedia.FunctionBasedMedia.Refrigerant.specificEnthalpy_pT(
        p=p_ex_start,
        T=T_su_start,
        refrigerantName="Refprop.R245FA"));
  ...
  Modelica.Units.SI.Frequency N_rot(start=N_rot_start) "Rotating speed in Hz";
